"""Layer 2: feature engineering — computes 42 indicators across technical, volume, regime, and macro categories."""
...
class FundamentalFeatures:
    ...
    def compute_all(self, price_df: pd.DataFrame, symbol: str) -> pd.DataFrame:
        return self.generate_synthetic_fundamentals(symbol, price_df['date'].values)
